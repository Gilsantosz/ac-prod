...
export default function ParetoChart({ occurrences }) {
  ...
  return (
    <Card className="p-6 border-border/60">
      <h3 className="font-semibold mb-1">Gráfico de Pareto de Paradas</h3>
      <p className="text-sm text-muted-foreground mb-5">Motivos ordenados por impacto e % acumulado para priorização</p>
      <div className="h-80">
        <ResponsiveContainer width="100%" height="100%">
          <ComposedChart data={data} margin={{ top: 8, right: 8, left: -16, bottom: 40 }}>
            ...
            <YAxis yAxisId="left" tickFormatter={(v) => formatDuration(v)} tick={{ fontSize: 12, fill: 'hsl(var(--muted-foreground))' }} />

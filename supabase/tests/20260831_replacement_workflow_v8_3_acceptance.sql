-- AC.Prod2 — structural acceptance test for replacement workflow v8.3.
...
BEGIN
  ...
  IF coalesce((v_release ->> 'ready')::boolean, false) IS NOT TRUE
     OR v_release ->> 'migration_version' <> '20260831143323'
     OR v_release ->> 'release_version' <> '20260831_acprod_replacement_v8_3' THEN
  ...
  IF NOT EXISTS (
    ...
    WHERE release.version = '20260831_acprod_replacement_v8_3'
  ) THEN
...
ROLLBACK;
SELECT 'REPLACEMENT_WORKFLOW_V8_3_CONTRACT_OK' AS result;

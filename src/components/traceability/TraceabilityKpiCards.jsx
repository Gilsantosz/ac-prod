...
const ITEMS = [
  { key: 'total', label: 'Leituras hoje', icon: ScanLine, color: 'text-sky-600 bg-sky-50 dark:bg-sky-950/25' },
  { key: 'approved', label: 'Aprovadas', icon: CheckCircle2, color: 'text-emerald-600 bg-emerald-50 dark:bg-emerald-950/25' },
  { key: 'rejected', label: 'Reprovadas', icon: XCircle, color: 'text-red-600 bg-red-50 dark:bg-red-950/25' },

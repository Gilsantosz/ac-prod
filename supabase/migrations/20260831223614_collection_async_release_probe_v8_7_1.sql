-- AC.Prod2 v8.7.1 — marcador fail-closed da arquitetura assíncrona.
-- A prontidão passa a depender da coleta canônica e dos componentes reais do
-- inbox/worker, sem herdar flags da implementação síncrona v8.6.
...
AS $$
  ...
  flags AS (
    SELECT jsonb_build_object(
      ...
      'collection_async_no_legacy_sync_dependency', TRUE
    ) AS value
  )
  SELECT jsonb_build_object(
    'ready',
